...
print("Variable Interpolator - Updated Jacobian")

folder = "September_20_2024_16-53/"
######### INPUTS ###########################
...
df = pd.read_csv(folder + file_path, delimiter='\s+', header=None, names=column_names)
s2 = time.time()
...
ret_df.to_hdf(folder + '3D_data/all_data_updated_jacobian.h5', key='df', mode='w')
